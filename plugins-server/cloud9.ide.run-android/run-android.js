...
var NodeRuntimePlugin = function(ide, workspace) {
    ...
    this.channel = this.workspaceId + "::android-runtime";
...
(function() {
    ...
    this.init = function() {
        ...
        this.eventbus.on(this.channel, function(msg) {
            ...
            if (type == "android-start" || type == "android-exit") {
                self.workspace.getExt("state").publishState();
            }

            if (msg.type == "android-start") {
                self.processCount += 1;
            }

            if (msg.type == "android-exit") {
